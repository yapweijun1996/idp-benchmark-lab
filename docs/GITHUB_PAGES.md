...
Current status: **production NO-GO**. [DEPLOYMENT.md](../DEPLOYMENT.md) describes the workflow; [PROJECT_STATUS.md](../PROJECT_STATUS.md) holds dated verification. The current published checkpoint is `dd98943`; Actions run `34207495290` and the Pages deployment passed and published the bounded Gateway Demo image contract. Full real-PDF and quota/billing acceptance remain pending.
