...
Deliver:
- bundled demo fixture (`demo/popular-po/`: a synthetic purchase order PDF + matching prompt/
  schema/expected-result — not the real uncommitted "Popular PO" scan) generated by
